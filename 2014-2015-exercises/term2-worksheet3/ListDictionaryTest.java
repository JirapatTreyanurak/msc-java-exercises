 ...
 * @version 03-02-15
 * 
 * This class contains the test cases for Worksheet 3 Part 2 solutions.
 * 
 */
public class ListDictionaryTest {
	...
	public void signatureToWordsTest1 () {
		...
		Set<String> result = this.ld.signatureToWords("");
	...
	public void signatureToWordsTest2 () {
		...
		expected.add("b");
		expected.add("c");
		Set<String> result = this.ld.signatureToWords("2");
		assertEquals(expected, result);
	}
	@Test
	public void signatureToWordsTest3 () {
		...
		expected.add("clu");
		expected.add("clv");
		Set<String> result = this.ld.signatureToWords("258");
		assertEquals(expected, result);
	}
	@Test
	public void signatureToWordsTest4 () {
		Set<String> expected = new TreeSet<String>();
		Set<String> result = this.ld.signatureToWords("2554876548");
		assertEquals(expected, result);
	}
